...
Failure case
1、
A human medieval knight wearing full plate armor draws a large sword, swings it at a large green monster, then lowers the sword and walks away."

Two human medieval knights wearing full plate armor fight each other with swords. They face each other, charge forward, clash their swords, and continue fighting in the middle of a battlefield."

A scuba diver swims through a deep underwater environment, exploring a sunken ship surrounded by colorful coral reefs and schools of fish. Sunbeams penetrate the blue water from above as the diver slowly moves forward

A scuba diver exploring the deep ocean encounters two enormous sperm whales. The two whales slowly swim around the diver and move through the dark blue underwater environment, while beams of sunlight penetrate the water from above." 

A scuba diver exploring the deep ocean encounters two enormous anglerfish. The two giant anglerfish slowly swim around the diver in the dark blue underwater environment, their glowing lures illuminating the surrounding water

A scuba diver exploring the deep ocean encounters a giant seahorse. The seahorse slowly swims through the dark blue water among coral reefs and seaweed, while light rays shine down from the surface.

A scuba diver exploring the deep ocean encounters Cthulhu. Cthulhu slowly emerges from the darkness and moves through the underwater ruins, while the diver watches from a distance. Faint light rays penetrate the deep blue water, creating an eerie atmosphere."
...
--
A fixed-camera shot of exactly one red apple on a white table. No people or other objects are present.
Exactly two objects are placed on a plain white table: one red cube and one blue sphere. No other objects or people appear." \
A single blue ceramic cup sits on an empty white table. No other objects are present."




A red sedan overtakes a blue sedan, makes a U-turn, and drives back along the same road.

A side-view shot of a red sedan driving forward on a straight road. The red sedan passes a blue sedan, slows down, makes a complete 180-degree U-turn, and then drives back in the opposite direction along the same road. The U-turn must be clearly visible.


3D consistency failure / multi-view consistency failure

The camera makes a complete 360-degree rotation around a statue in a small courtyard and returns to its original viewpoint.
A continuous cinematic orbit shot around a stone statue standing in the center of a normal outdoor courtyard. The camera circles clockwise around the statue two complete times, completing exactly two full 360-degree orbits, for a total of 720 degrees. The camera maintains a constant distance and height. The statue remains motionless, fully visible, centered, and in focus. No zoom, no fisheye distortion, and no cuts. After the second orbit, the camera returns to its starting viewpoint.
